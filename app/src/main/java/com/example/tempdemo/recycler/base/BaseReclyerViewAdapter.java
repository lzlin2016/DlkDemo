package com.example.tempdemo.recycler.base;
...
import com.example.tempdemo.recycler.animation.AlphaInAnimation;
import com.example.tempdemo.recycler.animation.BaseAnimation;
 ...
 * on 2016.04.17:03
 */
public abstract class BaseReclyerViewAdapter<H extends RecyclerView.ViewHolder, T>
    ...
    public abstract H createVH(ViewGroup parent, int viewType);

    public abstract void bindVH(H holder, int position);
